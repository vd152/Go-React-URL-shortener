        ...
        return(
            <form id="form">
                <div className="row text-center justify-content-center mt-5">
                    <div className="col-xl-4 col-10 form-group has-error p-xl-2 m-xl-2 p-md-0 m-md-0">
                        <div className="form-horizontal row ">
                            ...
                            <div className="col-10 pl-0 pr-xl-3 pr-0" >
                    ...
                    <div className="col-xl-4 col-10 form-group has-error p-xl-2 m-xl-2 p-md-0 m-md-0">
                        ...
                        <div className="col-5 control-label" style={{backgroundColor: '#108dbe'}}>
                            ...
                            <div className="col-5 pl-0 pr-xl-3 pr-0">
                    ...
                    <div className="col-xl-2 col-10 form-group p-2 m-2 text-center">
